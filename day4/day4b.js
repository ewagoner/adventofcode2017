...
var phrases = `nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
...
var lines = phraseArray.length;

var valid = 0;

for (var i = 0; i < lines; i++) {
    var words = phraseArray[i].split(/(\s+)/).filter( function(e) { return e.trim().length > 0; } );
